            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-content">
                    ...
                    <ul class="media-list dropdown-content-body width-300">
                        <li class="media">
                            <div class="media-left"><img src="<?= SITE_PUBLIC ?>/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
                            <div class="media-body">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown language-switch">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?= SITE_PUBLIC ?>/assets/images/flags/gb.png" class="position-left" alt="">
                    English
                    <span class="caret"></span>
                </a>

                <ul class="dropdown-menu">
                    <li><a class="deutsch"><img src="<?= SITE_PUBLIC ?>/assets/images/flags/de.png" alt=""> Deutsch</a></li>
                    <li><a class="ukrainian"><img src="<?= SITE_PUBLIC ?>/assets/images/flags/ua.png" alt=""> Українська</a></li>
                    <li><a class="english"><img src="<?= SITE_PUBLIC ?>/assets/images/flags/gb.png" alt=""> English</a></li>
                    <li><a class="espana"><img src="<?= SITE_PUBLIC ?>/assets/images/flags/es.png" alt=""> España</a></li>
                    <li><a class="russian"><img src="<?= SITE_PUBLIC ?>/assets/images/flags/ru.png" alt=""> Русский</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-content width-350">
                    ...
                    <ul class="media-list dropdown-content-body">
                        <li class="media">
                            <div class="media-left">
                                <img src="<?= SITE_PUBLIC ?>/assets/images/placeholder.jpg" class="img-circle img-sm" alt="">
            ...
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?= SITE_PUBLIC ?>/assets/images/placeholder.jpg" alt="">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li><a href="<?= SITE_URL ?>/Admin/runLogout"><i class="icon-switch2"></i> Çıkış Yap</a></li>
                </ul>
            </li>
        </ul>
    </div>
